    ...
    >
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-3 gap-6 h-auto md:h-[600px]">
          {/* 1. CAJA PRINCIPAL (Perfil) - Ocupa 2/3 del ancho */}
          <motion.div
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 text-base md:text-lg max-w-md leading-relaxed mt-2">
                Ingeniero de Software. Ex-Intern en Claro y desarrollador Full
                Stack apasionado por crear soluciones robustas y escalables.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mt-6 md:mt-0 relative z-20">
              ...
              >
                Contáctame <Mail size={20} />
              </a>
            </div>
          </motion.div>

          {/* 2. CAJA DE FOTO - Full Color */}
          <motion.div
          ...
          >
            {/* AQUÍ ESTÁ EL CAMBIO: Quité la clase 'grayscale' */}
            <img
              src="/images/yo.jpeg"
              alt="Josué Alvarado"
          ...
          {/* 3. CAJA DE ESTADO (Abajo Izquierda) */}
          <motion.div
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-2 relative z-10">
              ...
              <h3 className="text-violet-200 font-bold">Estado Actual</h3>
            </div>
          ...
          {/* 4. CAJA DE STACK EXPANDIDA (Abajo Derecha - Ocupa 2 espacios ahora) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4 }}
            // CAMBIO: Ahora es col-span-2 para llenar el hueco
          ...
          >
            ...
            <div className="relative z-10 text-center md:text-left mb-4 md:mb-0">
              <h3 className="text-white font-bold text-2xl mb-1">Tech Stack</h3>
